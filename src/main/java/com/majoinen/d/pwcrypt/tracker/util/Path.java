...
public class Path {
    public static class Web {
        ...
        // Route for verify email address and device
        public static final String VERIFY_EMAIL_DEVICE =
          "/verify-email-device/:email_code/:device_code/";
